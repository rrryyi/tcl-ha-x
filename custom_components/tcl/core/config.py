...
class EntityFilterConfig:
    ...
    def set_filter_type(self, device_id: str, filter_type: str) -> None:
        if filter_type not in [FILTER_TYPE_EXCLUDE, FILTER_TYPE_INCLUDE]:
            raise ValueError()
        ...
        for index, item in enumerate(self._cfg):
            ...
            self._cfg.append(self._generate_entity_filter_item(device_id, filter_type=filter_type))
    ...
    def set_target_entities(self, device_id: str, entities: List[str]) -> None:
        ...
        for index, item in enumerate(self._cfg):
            ...
            self._cfg.append(self._generate_entity_filter_item(device_id, target_entities=entities))
    ...
    @staticmethod
    def _generate_entity_filter_item(
        device_id: str,
        filter_type: str = FILTER_TYPE_INCLUDE,
